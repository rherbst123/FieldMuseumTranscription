...
class ImageProcessorGUI:
    ...
    def display_image(self, image):
        ...
        self.image_label.bind("<Button-1>", lambda event: self.open_image(image))
    ...
    def open_output_directory(self, output_file):
        ...
        os.startfile(output_dir)  # This works on Windows. For Mac and Linux, use subprocess.
