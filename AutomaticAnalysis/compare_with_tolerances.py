...
class Comparison:
    ...
    def setup_interfaces(self, config):
        ...
        self.USE_TOLERANCES = tolerances_config["USE_TOLERANCES"] == "True"
        self.TOLS = tolerances_config["TOLS"] if self.USE_TOLERANCES else {}
        self.field_tolerances = FieldTolerances(tolerances_config)
