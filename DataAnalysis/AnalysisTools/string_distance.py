...
class WeightedLevenshtein(StringDistance):
    ...
    def update_costs(self, config):
        ...
        self.update_substition_transposition_costs(custom_substitution_char_costs, self.SUBSTITUTE_COSTS)   
    ...
    def update_substition_transposition_costs(self, custom_char_costs: list[list], costs_lists):
        if not custom_char_costs[0] or not custom_char_costs[0][0]:
            return
